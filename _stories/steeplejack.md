...
title: "Steeplejack" # The identity that can be used to generate heading and title tags

text: # Text Block
  description: >  
    Steeple climbers beccome steeple jacks
  lead:
  excerpt:
...
seo:
  type: article
  keywords: [Labouror, cities, urban, Industrial Revolution]
